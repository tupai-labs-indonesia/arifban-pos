        ...
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="nama_produk" class="col-lg-2 col-lg-offset-1 control-label">Ukuran</label>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="type" class="col-lg-2 col-lg-offset-1 control-label">Type</label>
                        <div class="col-lg-6">
                            <select name="type" id="type" class="form-control" required>
                                <option value="">Pilih Type</option>
                                <option value="Ban Radial">Ban Radial</option>
                                <option value="Ban Bias">Ban Bias</option>
                                <option value="Ban RFT">Ban RFT</option>
                                <option value="Ban Tebeless">Ban Tebeless</option>
                                <option value="Ban HT">Ban HT</option>
                                <option value="Ban MT">Ban MT</option>
                                <option value="Ban AT">Ban AT</option>
                            </select>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
